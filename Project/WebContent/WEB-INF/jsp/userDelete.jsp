...
<h1 class="text-center">ユーザ削除確認</h1><br>
  ...
  <br>
  <br>
  <a class="btn btn-primary btn-lg btn-block" href="UserListServret" role="button">キャンセル</a>
  <a class="btn btn-danger  btn-lg btn-block" href="UserListServret" role="button">削除</a>
</div>
 </form>
 </div>
</body>
